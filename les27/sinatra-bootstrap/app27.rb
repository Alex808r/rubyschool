...
configure do
  ...
  seed_db db, ['Jessie', 'Bak', 'Jack', 'Mike']
...
post '/visit' do
  ...
  @message = "Dear #{@username}, we'll be waiting for you at #{@userdate}. Your number: #{@userphone}. Master:#{@barber}"
